 ...
 *  </code>
 */
class Google_Service_Storagetransfer_Resource_TransferOperations extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function cancel($name, $optParams = array())
  {
    ...
    return $this->call('cancel', array($params), "\GoogleApiServices\Google_Service_Storagetransfer_StoragetransferEmpty");
  }
  /**
  ...
  public function delete($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "\GoogleApiServices\Google_Service_Storagetransfer_StoragetransferEmpty");
  }
  /**
  ...
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Storagetransfer_Operation");
  }
  /**
  ...
  public function listTransferOperations($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Storagetransfer_ListOperationsResponse");
  }
  /**
  ...
  public function pause($name, Google_Service_Storagetransfer_PauseTransferOperationRequest $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('pause', array($params), "\GoogleApiServices\Google_Service_Storagetransfer_StoragetransferEmpty");
  }
  /**
  ...
  public function resume($name, Google_Service_Storagetransfer_ResumeTransferOperationRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('resume', array($params), "\GoogleApiServices\Google_Service_Storagetransfer_StoragetransferEmpty");
  }
}
