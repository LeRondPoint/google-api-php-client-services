 ...
 *  </code>
 */
class Google_Service_Storagetransfer_Resource_TransferJobs extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function create(Google_Service_Storagetransfer_TransferJob $postBody, $optParams = array())
  {
    ...
    return $this->call('create', array($params), "\GoogleApiServices\Google_Service_Storagetransfer_TransferJob");
  }
  /**
  ...
  public function get($jobName, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Storagetransfer_TransferJob");
  }
  /**
  ...
  public function listTransferJobs($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Storagetransfer_ListTransferJobsResponse");
  }
  /**
  ...
  public function patch($jobName, Google_Service_Storagetransfer_UpdateTransferJobRequest $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "\GoogleApiServices\Google_Service_Storagetransfer_TransferJob");
  }
}
