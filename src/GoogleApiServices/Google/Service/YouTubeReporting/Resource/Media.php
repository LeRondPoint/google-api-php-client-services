 ...
 *  </code>
 */
class Google_Service_YouTubeReporting_Resource_Media extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function download($resourceName, $optParams = array())
  {
    ...
    return $this->call('download', array($params), "\GoogleApiServices\Google_Service_YouTubeReporting_Media");
  }
}
