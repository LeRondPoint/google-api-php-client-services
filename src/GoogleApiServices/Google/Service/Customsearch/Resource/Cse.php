 ...
 *  </code>
 */
class Google_Service_Customsearch_Resource_Cse extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listCse($q, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Customsearch_Search");
  }
}
