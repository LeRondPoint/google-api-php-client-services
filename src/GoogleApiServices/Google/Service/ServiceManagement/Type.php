...
class Google_Service_ServiceManagement_Type extends \GoogleApi\Google_Collection
{
  protected $collection_key = 'options';
  protected $fieldsType = '\GoogleApiServices\Google_Service_ServiceManagement_Field';
