 ...
 *  </code>
 */
class Google_Service_Urlshortener_Resource_Url extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($shortUrl, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Urlshortener_Url");
  }
  /**
  ...
  public function insert(Google_Service_Urlshortener_Url $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_Urlshortener_Url");
  }
  /**
  ...
  public function listUrl($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Urlshortener_UrlHistory");
  }
}
