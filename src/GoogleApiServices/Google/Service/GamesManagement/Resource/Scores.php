 ...
 *  </code>
 */
class Google_Service_GamesManagement_Resource_Scores extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function reset($leaderboardId, $optParams = array())
  {
    ...
    return $this->call('reset', array($params), "\GoogleApiServices\Google_Service_GamesManagement_PlayerScoreResetResponse");
  }
  /**
  ...
  public function resetAll($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('resetAll', array($params), "\GoogleApiServices\Google_Service_GamesManagement_PlayerScoreResetAllResponse");
  }
  /**
