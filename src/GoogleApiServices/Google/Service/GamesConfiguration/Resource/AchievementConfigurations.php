 ...
 *  </code>
 */
class Google_Service_GamesConfiguration_Resource_AchievementConfigurations extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($achievementId, $optParams = array())
  {
    $params = array('achievementId' => $achievementId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_GamesConfiguration_AchievementConfiguration");
  }
  /**
  ...
  public function insert($applicationId, Google_Service_GamesConfiguration_AchievementConfiguration $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_GamesConfiguration_AchievementConfiguration");
  }
  /**
  ...
  public function listAchievementConfigurations($applicationId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_GamesConfiguration_AchievementConfigurationListResponse");
  }
  /**
  ...
  public function patch($achievementId, Google_Service_GamesConfiguration_AchievementConfiguration $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "\GoogleApiServices\Google_Service_GamesConfiguration_AchievementConfiguration");
  }
  /**
  ...
  public function update($achievementId, Google_Service_GamesConfiguration_AchievementConfiguration $postBody, $optParams = array())
  {
    $params = array('achievementId' => $achievementId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_GamesConfiguration_AchievementConfiguration");
  }
}
