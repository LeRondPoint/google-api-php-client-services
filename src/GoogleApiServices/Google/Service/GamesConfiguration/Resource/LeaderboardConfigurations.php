 ...
 *  </code>
 */
class Google_Service_GamesConfiguration_Resource_LeaderboardConfigurations extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($leaderboardId, $optParams = array())
  {
    $params = array('leaderboardId' => $leaderboardId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_GamesConfiguration_LeaderboardConfiguration");
  }
  /**
  ...
  public function insert($applicationId, Google_Service_GamesConfiguration_LeaderboardConfiguration $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_GamesConfiguration_LeaderboardConfiguration");
  }
  /**
  ...
  public function listLeaderboardConfigurations($applicationId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_GamesConfiguration_LeaderboardConfigurationListResponse");
  }
  /**
  ...
  public function patch($leaderboardId, Google_Service_GamesConfiguration_LeaderboardConfiguration $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "\GoogleApiServices\Google_Service_GamesConfiguration_LeaderboardConfiguration");
  }
  /**
  ...
  public function update($leaderboardId, Google_Service_GamesConfiguration_LeaderboardConfiguration $postBody, $optParams = array())
  {
    $params = array('leaderboardId' => $leaderboardId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_GamesConfiguration_LeaderboardConfiguration");
  }
}
