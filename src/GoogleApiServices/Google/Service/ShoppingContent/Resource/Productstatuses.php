 ...
 *  </code>
 */
class Google_Service_ShoppingContent_Resource_Productstatuses extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function custombatch(Google_Service_ShoppingContent_ProductstatusesCustomBatchRequest $postBody, $optParams = array())
  {
    ...
    return $this->call('custombatch', array($params), "\GoogleApiServices\Google_Service_ShoppingContent_ProductstatusesCustomBatchResponse");
  }
  /**
  ...
  public function get($merchantId, $productId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_ShoppingContent_ProductStatus");
  }
  /**
  ...
  public function listProductstatuses($merchantId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_ShoppingContent_ProductstatusesListResponse");
  }
}
