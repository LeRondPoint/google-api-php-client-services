 ...
 *  </code>
 */
class Google_Service_ShoppingContent_Resource_Accountshipping extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function custombatch(Google_Service_ShoppingContent_AccountshippingCustomBatchRequest $postBody, $optParams = array())
  {
    ...
    return $this->call('custombatch', array($params), "\GoogleApiServices\Google_Service_ShoppingContent_AccountshippingCustomBatchResponse");
  }
  /**
  ...
  public function get($merchantId, $accountId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_ShoppingContent_AccountShipping");
  }
  /**
  ...
  public function listAccountshipping($merchantId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_ShoppingContent_AccountshippingListResponse");
  }
  /**
  ...
  public function patch($merchantId, $accountId, Google_Service_ShoppingContent_AccountShipping $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "\GoogleApiServices\Google_Service_ShoppingContent_AccountShipping");
  }
  /**
  ...
  public function update($merchantId, $accountId, Google_Service_ShoppingContent_AccountShipping $postBody, $optParams = array())
  {
    $params = array('merchantId' => $merchantId, 'accountId' => $accountId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_ShoppingContent_AccountShipping");
  }
}
