 ...
 *  </code>
 */
class Google_Service_ShoppingContent_Resource_Datafeeds extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function custombatch(Google_Service_ShoppingContent_DatafeedsCustomBatchRequest $postBody, $optParams = array())
  {
    ...
    return $this->call('custombatch', array($params), "\GoogleApiServices\Google_Service_ShoppingContent_DatafeedsCustomBatchResponse");
  }
  /**
  ...
  public function get($merchantId, $datafeedId, $optParams = array())
  {
    $params = array('merchantId' => $merchantId, 'datafeedId' => $datafeedId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_ShoppingContent_Datafeed");
  }
  /**
  ...
  public function insert($merchantId, Google_Service_ShoppingContent_Datafeed $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_ShoppingContent_Datafeed");
  }
  /**
  ...
  public function listDatafeeds($merchantId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_ShoppingContent_DatafeedsListResponse");
  }
  /**
  ...
  public function patch($merchantId, $datafeedId, Google_Service_ShoppingContent_Datafeed $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "\GoogleApiServices\Google_Service_ShoppingContent_Datafeed");
  }
  /**
  ...
  public function update($merchantId, $datafeedId, Google_Service_ShoppingContent_Datafeed $postBody, $optParams = array())
  {
    $params = array('merchantId' => $merchantId, 'datafeedId' => $datafeedId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_ShoppingContent_Datafeed");
  }
}
