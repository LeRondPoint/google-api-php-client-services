 ...
 *  </code>
 */
class Google_Service_ShoppingContent_Resource_Accountstatuses extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function custombatch(Google_Service_ShoppingContent_AccountstatusesCustomBatchRequest $postBody, $optParams = array())
  {
    ...
    return $this->call('custombatch', array($params), "\GoogleApiServices\Google_Service_ShoppingContent_AccountstatusesCustomBatchResponse");
  }
  /**
  ...
  public function get($merchantId, $accountId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_ShoppingContent_AccountStatus");
  }
  /**
  ...
  public function listAccountstatuses($merchantId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_ShoppingContent_AccountstatusesListResponse");
  }
}
