...
class Google_Service_ShoppingContent_AccountsCustomBatchResponseEntry extends \GoogleApi\Google_Model
{
  protected $accountType = '\GoogleApiServices\Google_Service_ShoppingContent_Account';
