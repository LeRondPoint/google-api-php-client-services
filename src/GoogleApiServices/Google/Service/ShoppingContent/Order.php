...
class Google_Service_ShoppingContent_Order extends \GoogleApi\Google_Collection
{
  protected $collection_key = 'shipments';
  public $acknowledged;
  public $channelType;
  protected $customerType = '\GoogleApiServices\Google_Service_ShoppingContent_OrderCustomer';
  protected $customerDataType = '';
  protected $deliveryDetailsType = '\GoogleApiServices\Google_Service_ShoppingContent_OrderDeliveryDetails';
  protected $deliveryDetailsDataType = '';
  public $id;
  public $kind;
  protected $lineItemsType = '\GoogleApiServices\Google_Service_ShoppingContent_OrderLineItem';
  protected $lineItemsDataType = 'array';
  public $merchantId;
  public $merchantOrderId;
  protected $netAmountType = '\GoogleApiServices\Google_Service_ShoppingContent_Price';
  protected $netAmountDataType = '';
  protected $paymentMethodType = '\GoogleApiServices\Google_Service_ShoppingContent_OrderPaymentMethod';
  ...
  protected $refundsType = '\GoogleApiServices\Google_Service_ShoppingContent_OrderRefund';
  protected $refundsDataType = 'array';
  protected $shipmentsType = '\GoogleApiServices\Google_Service_ShoppingContent_OrderShipment';
