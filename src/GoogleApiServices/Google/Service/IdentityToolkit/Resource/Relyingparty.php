 ...
 *  </code>
 */
class Google_Service_IdentityToolkit_Resource_Relyingparty extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function createAuthUri(Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartyCreateAuthUriRequest $postBody, $optParams = array())
  {
    ...
    return $this->call('createAuthUri', array($params), "\GoogleApiServices\Google_Service_IdentityToolkit_CreateAuthUriResponse");
  }
  /**
  ...
  public function deleteAccount(Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartyDeleteAccountRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('deleteAccount', array($params), "\GoogleApiServices\Google_Service_IdentityToolkit_DeleteAccountResponse");
  }
  /**
  ...
  public function downloadAccount(Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartyDownloadAccountRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('downloadAccount', array($params), "\GoogleApiServices\Google_Service_IdentityToolkit_DownloadAccountResponse");
  }
  /**
  ...
  public function getAccountInfo(Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartyGetAccountInfoRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('getAccountInfo', array($params), "\GoogleApiServices\Google_Service_IdentityToolkit_GetAccountInfoResponse");
  }
  /**
  ...
  public function getOobConfirmationCode(Google_Service_IdentityToolkit_Relyingparty $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('getOobConfirmationCode', array($params), "\GoogleApiServices\Google_Service_IdentityToolkit_GetOobConfirmationCodeResponse");
  }
  /**
  ...
  public function getProjectConfig($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('getProjectConfig', array($params), "\GoogleApiServices\Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartyGetProjectConfigResponse");
  }
  /**
  ...
  public function getPublicKeys($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('getPublicKeys', array($params), "\GoogleApiServices\Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartyGetPublicKeysResponse");
  }
  /**
  ...
  public function getRecaptchaParam($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('getRecaptchaParam', array($params), "\GoogleApiServices\Google_Service_IdentityToolkit_GetRecaptchaParamResponse");
  }
  /**
  ...
  public function resetPassword(Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartyResetPasswordRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('resetPassword', array($params), "\GoogleApiServices\Google_Service_IdentityToolkit_ResetPasswordResponse");
  }
  /**
  ...
  public function setAccountInfo(Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartySetAccountInfoRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('setAccountInfo', array($params), "\GoogleApiServices\Google_Service_IdentityToolkit_SetAccountInfoResponse");
  }
  /**
  ...
  public function setProjectConfig(Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartySetProjectConfigRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('setProjectConfig', array($params), "\GoogleApiServices\Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartySetProjectConfigResponse");
  }
  /**
  ...
  public function signOutUser(Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartySignOutUserRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('signOutUser', array($params), "\GoogleApiServices\Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartySignOutUserResponse");
  }
  /**
  ...
  public function signupNewUser(Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartySignupNewUserRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('signupNewUser', array($params), "\GoogleApiServices\Google_Service_IdentityToolkit_SignupNewUserResponse");
  }
  /**
  ...
  public function uploadAccount(Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartyUploadAccountRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('uploadAccount', array($params), "\GoogleApiServices\Google_Service_IdentityToolkit_UploadAccountResponse");
  }
  /**
  ...
  public function verifyAssertion(Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartyVerifyAssertionRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('verifyAssertion', array($params), "\GoogleApiServices\Google_Service_IdentityToolkit_VerifyAssertionResponse");
  }
  /**
  ...
  public function verifyCustomToken(Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartyVerifyCustomTokenRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('verifyCustomToken', array($params), "\GoogleApiServices\Google_Service_IdentityToolkit_VerifyCustomTokenResponse");
  }
  /**
  ...
  public function verifyPassword(Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartyVerifyPasswordRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('verifyPassword', array($params), "\GoogleApiServices\Google_Service_IdentityToolkit_VerifyPasswordResponse");
  }
}
