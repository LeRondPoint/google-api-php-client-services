 ...
 *  </code>
 */
class Google_Service_SiteVerification_Resource_WebResource extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($id, $optParams = array())
  {
    $params = array('id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_SiteVerification_SiteVerificationWebResourceResource");
  }
  /**
  ...
  public function getToken(Google_Service_SiteVerification_SiteVerificationWebResourceGettokenRequest $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('getToken', array($params), "\GoogleApiServices\Google_Service_SiteVerification_SiteVerificationWebResourceGettokenResponse");
  }
  /**
  ...
  public function insert($verificationMethod, Google_Service_SiteVerification_SiteVerificationWebResourceResource $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_SiteVerification_SiteVerificationWebResourceResource");
  }
  /**
  ...
  public function listWebResource($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_SiteVerification_SiteVerificationWebResourceListResponse");
  }
  /**
  ...
  public function patch($id, Google_Service_SiteVerification_SiteVerificationWebResourceResource $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "\GoogleApiServices\Google_Service_SiteVerification_SiteVerificationWebResourceResource");
  }
  /**
  ...
  public function update($id, Google_Service_SiteVerification_SiteVerificationWebResourceResource $postBody, $optParams = array())
  {
    $params = array('id' => $id, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_SiteVerification_SiteVerificationWebResourceResource");
  }
}
