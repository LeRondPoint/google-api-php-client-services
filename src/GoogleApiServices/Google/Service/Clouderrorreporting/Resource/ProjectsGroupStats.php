 ...
 *  </code>
 */
class Google_Service_Clouderrorreporting_Resource_ProjectsGroupStats extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listProjectsGroupStats($projectName, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Clouderrorreporting_ListGroupStatsResponse");
  }
}
