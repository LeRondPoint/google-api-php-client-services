 ...
 *  </code>
 */
class Google_Service_Reseller_Resource_Subscriptions extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function activate($customerId, $subscriptionId, $optParams = array())
  {
    ...
    return $this->call('activate', array($params), "\GoogleApiServices\Google_Service_Reseller_Subscription");
  }
  /**
  ...
  public function changePlan($customerId, $subscriptionId, Google_Service_Reseller_ChangePlanRequest $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('changePlan', array($params), "\GoogleApiServices\Google_Service_Reseller_Subscription");
  }
  /**
  ...
  public function changeRenewalSettings($customerId, $subscriptionId, Google_Service_Reseller_RenewalSettings $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('changeRenewalSettings', array($params), "\GoogleApiServices\Google_Service_Reseller_Subscription");
  }
  /**
  ...
  public function changeSeats($customerId, $subscriptionId, Google_Service_Reseller_Seats $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('changeSeats', array($params), "\GoogleApiServices\Google_Service_Reseller_Subscription");
  }
  /**
  ...
  public function get($customerId, $subscriptionId, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Reseller_Subscription");
  }
  /**
  ...
  public function insert($customerId, Google_Service_Reseller_Subscription $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_Reseller_Subscription");
  }
  /**
  ...
  public function listSubscriptions($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Reseller_Subscriptions");
  }
  /**
  ...
  public function startPaidService($customerId, $subscriptionId, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId);
    $params = array_merge($params, $optParams);
    return $this->call('startPaidService', array($params), "\GoogleApiServices\Google_Service_Reseller_Subscription");
  }
  /**
  ...
  public function suspend($customerId, $subscriptionId, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId);
    $params = array_merge($params, $optParams);
    return $this->call('suspend', array($params), "\GoogleApiServices\Google_Service_Reseller_Subscription");
  }
}
