...
class Google_Service_Reseller_SubscriptionPlan extends \GoogleApi\Google_Model
{
  protected $commitmentIntervalType = '\GoogleApiServices\Google_Service_Reseller_SubscriptionPlanCommitmentInterval';
