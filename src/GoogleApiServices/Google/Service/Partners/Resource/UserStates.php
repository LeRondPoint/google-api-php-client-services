 ...
 *  </code>
 */
class Google_Service_Partners_Resource_UserStates extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listUserStates($optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Partners_ListUserStatesResponse");
  }
}
