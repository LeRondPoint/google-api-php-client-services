 ...
 *  </code>
 */
class Google_Service_Partners_Resource_ClientMessages extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function log(Google_Service_Partners_LogMessageRequest $postBody, $optParams = array())
  {
    ...
    return $this->call('log', array($params), "\GoogleApiServices\Google_Service_Partners_LogMessageResponse");
  }
}
