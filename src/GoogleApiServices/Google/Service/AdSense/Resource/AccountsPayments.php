 ...
 *  </code>
 */
class Google_Service_AdSense_Resource_AccountsPayments extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listAccountsPayments($accountId, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_AdSense_Payments");
  }
}
