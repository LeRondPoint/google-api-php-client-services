 ...
 *  </code>
 */
class Google_Service_AdSense_Resource_AccountsAlerts extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listAccountsAlerts($accountId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_AdSense_Alerts");
  }
}
