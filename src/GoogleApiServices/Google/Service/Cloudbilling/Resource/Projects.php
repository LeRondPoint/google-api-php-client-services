 ...
 *  </code>
 */
class Google_Service_Cloudbilling_Resource_Projects extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function getBillingInfo($name, $optParams = array())
  {
    ...
    return $this->call('getBillingInfo', array($params), "\GoogleApiServices\Google_Service_Cloudbilling_ProjectBillingInfo");
  }
  /**
  ...
  public function updateBillingInfo($name, Google_Service_Cloudbilling_ProjectBillingInfo $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('updateBillingInfo', array($params), "\GoogleApiServices\Google_Service_Cloudbilling_ProjectBillingInfo");
  }
}
