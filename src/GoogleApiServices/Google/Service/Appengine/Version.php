...
class Google_Service_Appengine_Version extends \GoogleApi\Google_Collection
{
  protected $collection_key = 'libraries';
  protected $apiConfigType = '\GoogleApiServices\Google_Service_Appengine_ApiConfigHandler';
  protected $apiConfigDataType = '';
  protected $automaticScalingType = '\GoogleApiServices\Google_Service_Appengine_AutomaticScaling';
  protected $automaticScalingDataType = '';
  protected $basicScalingType = '\GoogleApiServices\Google_Service_Appengine_BasicScaling';
  protected $basicScalingDataType = '';
  public $betaSettings;
  public $createTime;
  public $createdBy;
  public $defaultExpiration;
  protected $deploymentType = '\GoogleApiServices\Google_Service_Appengine_Deployment';
  protected $deploymentDataType = '';
  public $diskUsageBytes;
  public $env;
  public $envVariables;
  protected $errorHandlersType = '\GoogleApiServices\Google_Service_Appengine_ErrorHandler';
  protected $errorHandlersDataType = 'array';
  protected $handlersType = '\GoogleApiServices\Google_Service_Appengine_UrlMap';
  protected $handlersDataType = 'array';
  protected $healthCheckType = '\GoogleApiServices\Google_Service_Appengine_HealthCheck';
  protected $healthCheckDataType = '';
  public $id;
  public $inboundServices;
  public $instanceClass;
  protected $librariesType = '\GoogleApiServices\Google_Service_Appengine_Library';
  protected $librariesDataType = 'array';
  protected $manualScalingType = '\GoogleApiServices\Google_Service_Appengine_ManualScaling';
  protected $manualScalingDataType = '';
  public $name;
  protected $networkType = '\GoogleApiServices\Google_Service_Appengine_Network';
  protected $networkDataType = '';
  public $nobuildFilesRegex;
  protected $resourcesType = '\GoogleApiServices\Google_Service_Appengine_Resources';
