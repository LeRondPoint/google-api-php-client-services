 ...
 *  </code>
 */
class Google_Service_Appengine_Resource_AppsOperations extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($appsId, $operationsId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Appengine_Operation");
  }
  /**
  ...
  public function listAppsOperations($appsId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Appengine_ListOperationsResponse");
  }
}
