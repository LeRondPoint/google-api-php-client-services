 ...
 *  </code>
 */
class Google_Service_Autoscaler_Resource_Zones extends \GoogleApi\Google_Service_Resource
{
  /**
   * (zones.listZones)
   *
  ...
  public function listZones($optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Autoscaler_ZoneList");
  }
}
