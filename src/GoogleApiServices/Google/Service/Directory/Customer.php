...
class Google_Service_Directory_Customer extends \GoogleApi\Google_Model
{
  ...
  public $language;
  public $phoneNumber;
  protected $postalAddressType = '\GoogleApiServices\Google_Service_Directory_CustomerPostalAddress';
