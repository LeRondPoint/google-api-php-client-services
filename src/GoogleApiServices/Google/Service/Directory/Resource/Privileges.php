 ...
 *  </code>
 */
class Google_Service_Directory_Resource_Privileges extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listPrivileges($customer, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Directory_Privileges");
  }
}
