 ...
 *  </code>
 */
class Google_Service_Compute_Resource_Regions extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($project, $region, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Compute_Region");
  }
  /**
  ...
  public function listRegions($project, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Compute_RegionList");
  }
}
