 ...
 *  </code>
 */
class Google_Service_Compute_Resource_InstanceTemplates extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($project, $instanceTemplate, $optParams = array())
  {
    $params = array('project' => $project, 'instanceTemplate' => $instanceTemplate);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Compute_InstanceTemplate");
  }
  /**
  ...
  public function listInstanceTemplates($project, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Compute_InstanceTemplateList");
  }
}
