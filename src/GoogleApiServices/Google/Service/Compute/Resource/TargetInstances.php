 ...
 *  </code>
 */
class Google_Service_Compute_Resource_TargetInstances extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function aggregatedList($project, $optParams = array())
  {
    ...
    return $this->call('aggregatedList', array($params), "\GoogleApiServices\Google_Service_Compute_TargetInstanceAggregatedList");
  }
  /**
  ...
  public function get($project, $zone, $targetInstance, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'targetInstance' => $targetInstance);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Compute_TargetInstance");
  }
  /**
  ...
  public function listTargetInstances($project, $zone, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Compute_TargetInstanceList");
  }
}
