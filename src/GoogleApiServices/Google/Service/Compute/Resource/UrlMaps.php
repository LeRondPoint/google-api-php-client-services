 ...
 *  </code>
 */
class Google_Service_Compute_Resource_UrlMaps extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($project, $urlMap, $optParams = array())
  {
    $params = array('project' => $project, 'urlMap' => $urlMap);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Compute_UrlMap");
  }
  /**
  ...
  public function invalidateCache($project, $urlMap, Google_Service_Compute_CacheInvalidationRule $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('invalidateCache', array($params), "\GoogleApiServices\Google_Service_Compute_Operation");
  }
  /**
  ...
  public function listUrlMaps($project, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Compute_UrlMapList");
  }
  /**
  ...
  public function validate($project, $urlMap, Google_Service_Compute_UrlMapsValidateRequest $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'urlMap' => $urlMap, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('validate', array($params), "\GoogleApiServices\Google_Service_Compute_UrlMapsValidateResponse");
  }
}
