...
class Google_Service_Compute_Autoscaler extends \GoogleApi\Google_Model
{
  protected $autoscalingPolicyType = '\GoogleApiServices\Google_Service_Compute_AutoscalingPolicy';
