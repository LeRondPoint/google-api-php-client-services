...
class Google_Service_Compute_HealthCheck extends \GoogleApi\Google_Model
{
  public $checkIntervalSec;
  public $creationTimestamp;
  public $description;
  public $healthyThreshold;
  protected $http2HealthCheckType = '\GoogleApiServices\Google_Service_Compute_HTTP2HealthCheck';
  protected $http2HealthCheckDataType = '';
  protected $httpHealthCheckType = '\GoogleApiServices\Google_Service_Compute_HTTPHealthCheck';
  protected $httpHealthCheckDataType = '';
  protected $httpsHealthCheckType = '\GoogleApiServices\Google_Service_Compute_HTTPSHealthCheck';
  protected $httpsHealthCheckDataType = '';
  public $id;
  public $kind;
  public $name;
  public $selfLink;
  protected $sslHealthCheckType = '\GoogleApiServices\Google_Service_Compute_SSLHealthCheck';
  protected $sslHealthCheckDataType = '';
  protected $tcpHealthCheckType = '\GoogleApiServices\Google_Service_Compute_TCPHealthCheck';
