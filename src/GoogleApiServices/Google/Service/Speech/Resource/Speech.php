 ...
 *  </code>
 */
class Google_Service_Speech_Resource_Speech extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function asyncrecognize(Google_Service_Speech_AsyncRecognizeRequest $postBody, $optParams = array())
  {
    ...
    return $this->call('asyncrecognize', array($params), "\GoogleApiServices\Google_Service_Speech_Operation");
  }
  /**
  ...
  public function syncrecognize(Google_Service_Speech_SyncRecognizeRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('syncrecognize', array($params), "\GoogleApiServices\Google_Service_Speech_SyncRecognizeResponse");
  }
}
