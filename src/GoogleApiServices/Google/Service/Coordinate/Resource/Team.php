 ...
 *  </code>
 */
class Google_Service_Coordinate_Resource_Team extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listTeam($optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Coordinate_TeamListResponse");
  }
}
