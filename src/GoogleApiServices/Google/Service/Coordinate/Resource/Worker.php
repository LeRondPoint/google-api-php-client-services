 ...
 *  </code>
 */
class Google_Service_Coordinate_Resource_Worker extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listWorker($teamId, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Coordinate_WorkerListResponse");
  }
}
