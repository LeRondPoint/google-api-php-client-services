...
class Google_Service_Sheets_MoveDimensionRequest extends \GoogleApi\Google_Model
{
  public $destinationIndex;
  protected $sourceType = '\GoogleApiServices\Google_Service_Sheets_DimensionRange';
