...
class Google_Service_Sheets_UpdateNamedRangeRequest extends \GoogleApi\Google_Model
{
  public $fields;
  protected $namedRangeType = '\GoogleApiServices\Google_Service_Sheets_NamedRange';
