...
class Google_Service_Calendar_Event extends \GoogleApi\Google_Collection
{
  protected $collection_key = 'recurrence';
  public $anyoneCanAddSelf;
  protected $attachmentsType = '\GoogleApiServices\Google_Service_Calendar_EventAttachment';
  protected $attachmentsDataType = 'array';
  protected $attendeesType = '\GoogleApiServices\Google_Service_Calendar_EventAttendee';
  protected $attendeesDataType = 'array';
  public $attendeesOmitted;
  public $colorId;
  public $created;
  protected $creatorType = '\GoogleApiServices\Google_Service_Calendar_EventCreator';
  protected $creatorDataType = '';
  public $description;
  protected $endType = '\GoogleApiServices\Google_Service_Calendar_EventDateTime';
  protected $endDataType = '';
  public $endTimeUnspecified;
  public $etag;
  protected $extendedPropertiesType = '\GoogleApiServices\Google_Service_Calendar_EventExtendedProperties';
  protected $extendedPropertiesDataType = '';
  protected $gadgetType = '\GoogleApiServices\Google_Service_Calendar_EventGadget';
  ...
  public $location;
  public $locked;
  protected $organizerType = '\GoogleApiServices\Google_Service_Calendar_EventOrganizer';
  protected $organizerDataType = '';
  protected $originalStartTimeType = '\GoogleApiServices\Google_Service_Calendar_EventDateTime';
  protected $originalStartTimeDataType = '';
  public $privateCopy;
  public $recurrence;
  public $recurringEventId;
  protected $remindersType = '\GoogleApiServices\Google_Service_Calendar_EventReminders';
  protected $remindersDataType = '';
  public $sequence;
  protected $sourceType = '\GoogleApiServices\Google_Service_Calendar_EventSource';
  protected $sourceDataType = '';
  protected $startType = '\GoogleApiServices\Google_Service_Calendar_EventDateTime';
