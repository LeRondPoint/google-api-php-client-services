 ...
 *  </code>
 */
class Google_Service_Prediction_Resource_Trainedmodels extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function analyze($project, $id, $optParams = array())
  {
    ...
    return $this->call('analyze', array($params), "\GoogleApiServices\Google_Service_Prediction_Analyze");
  }
  /**
  ...
  public function get($project, $id, $optParams = array())
  {
    $params = array('project' => $project, 'id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Prediction_Insert2");
  }
  /**
  ...
  public function insert($project, Google_Service_Prediction_Insert $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_Prediction_Insert2");
  }
  /**
  ...
  public function listTrainedmodels($project, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Prediction_PredictionList");
  }
  /**
  ...
  public function predict($project, $id, Google_Service_Prediction_Input $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('predict', array($params), "\GoogleApiServices\Google_Service_Prediction_Output");
  }
  /**
  ...
  public function update($project, $id, Google_Service_Prediction_Update $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'id' => $id, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_Prediction_Insert2");
  }
}
