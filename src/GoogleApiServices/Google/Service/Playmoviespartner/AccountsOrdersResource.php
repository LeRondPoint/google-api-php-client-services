 ...
 *  </code>
 */
class Google_Service_Playmoviespartner_AccountsOrdersResource extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($accountId, $orderId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Playmoviespartner_Order");
  }
  /**
  ...
  public function listAccountsOrders($accountId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Playmoviespartner_ListOrdersResponse");
  }
}
