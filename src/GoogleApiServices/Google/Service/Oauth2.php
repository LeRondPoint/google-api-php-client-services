 ...
 * @author Google, Inc.
 */
class Google_Service_Oauth2 extends \GoogleApi\Google_Service
{
  ...
  public function getCertForOpenIdConnect($optParams = array())
  {
    ...
    return $this->base_methods->call('getCertForOpenIdConnect', array($params), "\GoogleApiServices\Google_Service_Oauth2_Jwk");
  }
  /**
   * (tokeninfo)
   *
  ...
  public function tokeninfo($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->base_methods->call('tokeninfo', array($params), "\GoogleApiServices\Google_Service_Oauth2_Tokeninfo");
  }
}
