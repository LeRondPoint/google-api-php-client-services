 ...
 *  </code>
 */
class Google_Service_Plus_Resource_People extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($userId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Plus_Person");
  }
  /**
  ...
  public function listPeople($userId, $collection, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Plus_PeopleFeed");
  }
  /**
  ...
  public function listByActivity($activityId, $collection, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('listByActivity', array($params), "\GoogleApiServices\Google_Service_Plus_PeopleFeed");
  }
  /**
  ...
  public function search($query, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "\GoogleApiServices\Google_Service_Plus_PeopleFeed");
  }
}
