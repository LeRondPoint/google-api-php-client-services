 ...
 *  </code>
 */
class Google_Service_CivicInfo_Resource_Representatives extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function representativeInfoByAddress($optParams = array())
  {
    ...
    return $this->call('representativeInfoByAddress', array($params), "\GoogleApiServices\Google_Service_CivicInfo_RepresentativeInfoResponse");
  }
  /**
  ...
  public function representativeInfoByDivision($ocdId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('representativeInfoByDivision', array($params), "\GoogleApiServices\Google_Service_CivicInfo_RepresentativeInfoData");
  }
}
