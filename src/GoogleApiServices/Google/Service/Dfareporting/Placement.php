...
class Google_Service_Dfareporting_Placement extends \GoogleApi\Google_Collection
{
  ...
  protected $placementGroupIdDimensionValueType = '\GoogleApiServices\Google_Service_Dfareporting_DimensionValue';
  protected $placementGroupIdDimensionValueDataType = '';
  public $placementStrategyId;
  protected $pricingScheduleType = '\GoogleApiServices\Google_Service_Dfareporting_PricingSchedule';
  protected $pricingScheduleDataType = '';
  public $primary;
  protected $publisherUpdateInfoType = '\GoogleApiServices\Google_Service_Dfareporting_LastModifiedInfo';
  protected $publisherUpdateInfoDataType = '';
  public $siteId;
  protected $siteIdDimensionValueType = '\GoogleApiServices\Google_Service_Dfareporting_DimensionValue';
