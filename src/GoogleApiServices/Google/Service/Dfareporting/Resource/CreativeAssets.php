 ...
 *  </code>
 */
class Google_Service_Dfareporting_Resource_CreativeAssets extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function insert($profileId, $advertiserId, Google_Service_Dfareporting_CreativeAssetMetadata $postBody, $optParams = array())
  {
    ...
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_Dfareporting_CreativeAssetMetadata");
  }
}
