 ...
 *  </code>
 */
class Google_Service_Dfareporting_Resource_OrderDocuments extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($profileId, $projectId, $id, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Dfareporting_OrderDocument");
  }
  /**
  ...
  public function listOrderDocuments($profileId, $projectId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Dfareporting_OrderDocumentsListResponse");
  }
}
