 ...
 *  </code>
 */
class Google_Service_Dfareporting_Resource_UserRolePermissions extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($profileId, $id, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Dfareporting_UserRolePermission");
  }
  /**
  ...
  public function listUserRolePermissions($profileId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Dfareporting_UserRolePermissionsListResponse");
  }
}
