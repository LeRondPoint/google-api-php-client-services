 ...
 *  </code>
 */
class Google_Service_Dfareporting_Resource_Metros extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listMetros($profileId, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Dfareporting_MetrosListResponse");
  }
}
