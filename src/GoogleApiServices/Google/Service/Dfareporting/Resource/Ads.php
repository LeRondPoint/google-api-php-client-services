 ...
 *  </code>
 */
class Google_Service_Dfareporting_Resource_Ads extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($profileId, $id, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Dfareporting_Ad");
  }
  /**
  ...
  public function insert($profileId, Google_Service_Dfareporting_Ad $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_Dfareporting_Ad");
  }
  /**
  ...
  public function listAds($profileId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Dfareporting_AdsListResponse");
  }
  /**
  ...
  public function patch($profileId, $id, Google_Service_Dfareporting_Ad $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "\GoogleApiServices\Google_Service_Dfareporting_Ad");
  }
  /**
  ...
  public function update($profileId, Google_Service_Dfareporting_Ad $postBody, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_Dfareporting_Ad");
  }
}
