 ...
 *  </code>
 */
class Google_Service_Dfareporting_Resource_Sizes extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($profileId, $id, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Dfareporting_Size");
  }
  /**
  ...
  public function insert($profileId, Google_Service_Dfareporting_Size $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_Dfareporting_Size");
  }
  /**
  ...
  public function listSizes($profileId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Dfareporting_SizesListResponse");
  }
}
