 ...
 *  </code>
 */
class Google_Service_Dfareporting_Resource_RemarketingListShares extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($profileId, $remarketingListId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Dfareporting_RemarketingListShare");
  }
  /**
  ...
  public function patch($profileId, $remarketingListId, Google_Service_Dfareporting_RemarketingListShare $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "\GoogleApiServices\Google_Service_Dfareporting_RemarketingListShare");
  }
  /**
  ...
  public function update($profileId, Google_Service_Dfareporting_RemarketingListShare $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_Dfareporting_RemarketingListShare");
  }
}
