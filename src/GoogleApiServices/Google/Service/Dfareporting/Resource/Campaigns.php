 ...
 *  </code>
 */
class Google_Service_Dfareporting_Resource_Campaigns extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($profileId, $id, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Dfareporting_Campaign");
  }
  /**
  ...
  public function insert($profileId, $defaultLandingPageName, $defaultLandingPageUrl, Google_Service_Dfareporting_Campaign $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_Dfareporting_Campaign");
  }
  /**
  ...
  public function listCampaigns($profileId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Dfareporting_CampaignsListResponse");
  }
  /**
  ...
  public function patch($profileId, $id, Google_Service_Dfareporting_Campaign $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "\GoogleApiServices\Google_Service_Dfareporting_Campaign");
  }
  /**
  ...
  public function update($profileId, Google_Service_Dfareporting_Campaign $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_Dfareporting_Campaign");
  }
}
