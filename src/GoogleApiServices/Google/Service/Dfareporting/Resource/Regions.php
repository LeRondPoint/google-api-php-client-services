 ...
 *  </code>
 */
class Google_Service_Dfareporting_Resource_Regions extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listRegions($profileId, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Dfareporting_RegionsListResponse");
  }
}
