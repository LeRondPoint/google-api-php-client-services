 ...
 *  </code>
 */
class Google_Service_Dfareporting_Resource_OperatingSystems extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($profileId, $dartId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Dfareporting_OperatingSystem");
  }
  /**
  ...
  public function listOperatingSystems($profileId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Dfareporting_OperatingSystemsListResponse");
  }
}
