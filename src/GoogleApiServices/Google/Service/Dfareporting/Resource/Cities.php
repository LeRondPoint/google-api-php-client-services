 ...
 *  </code>
 */
class Google_Service_Dfareporting_Resource_Cities extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listCities($profileId, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Dfareporting_CitiesListResponse");
  }
}
