 ...
 *  </code>
 */
class Google_Service_Dfareporting_Resource_Sites extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($profileId, $id, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Dfareporting_Site");
  }
  /**
  ...
  public function insert($profileId, Google_Service_Dfareporting_Site $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_Dfareporting_Site");
  }
  /**
  ...
  public function listSites($profileId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Dfareporting_SitesListResponse");
  }
  /**
  ...
  public function patch($profileId, $id, Google_Service_Dfareporting_Site $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "\GoogleApiServices\Google_Service_Dfareporting_Site");
  }
  /**
  ...
  public function update($profileId, Google_Service_Dfareporting_Site $postBody, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_Dfareporting_Site");
  }
}
