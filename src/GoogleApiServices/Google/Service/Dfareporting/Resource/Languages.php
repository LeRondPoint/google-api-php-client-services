 ...
 *  </code>
 */
class Google_Service_Dfareporting_Resource_Languages extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listLanguages($profileId, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Dfareporting_LanguagesListResponse");
  }
}
