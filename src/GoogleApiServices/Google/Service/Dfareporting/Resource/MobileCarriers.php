 ...
 *  </code>
 */
class Google_Service_Dfareporting_Resource_MobileCarriers extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($profileId, $id, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Dfareporting_MobileCarrier");
  }
  /**
  ...
  public function listMobileCarriers($profileId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Dfareporting_MobileCarriersListResponse");
  }
}
