 ...
 *  </code>
 */
class Google_Service_Dfareporting_Resource_Countries extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($profileId, $dartId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Dfareporting_Country");
  }
  /**
  ...
  public function listCountries($profileId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Dfareporting_CountriesListResponse");
  }
}
