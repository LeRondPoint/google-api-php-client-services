 ...
 *  </code>
 */
class Google_Service_Dfareporting_Resource_Browsers extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listBrowsers($profileId, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Dfareporting_BrowsersListResponse");
  }
}
