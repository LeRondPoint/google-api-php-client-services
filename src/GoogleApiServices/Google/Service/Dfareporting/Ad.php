...
class Google_Service_Dfareporting_Ad extends \GoogleApi\Google_Collection
{
  ...
  protected $clickThroughUrlSuffixPropertiesType = '\GoogleApiServices\Google_Service_Dfareporting_ClickThroughUrlSuffixProperties';
  protected $clickThroughUrlSuffixPropertiesDataType = '';
  public $comments;
  public $compatibility;
  protected $createInfoType = '\GoogleApiServices\Google_Service_Dfareporting_LastModifiedInfo';
  protected $createInfoDataType = '';
  protected $creativeGroupAssignmentsType = '\GoogleApiServices\Google_Service_Dfareporting_CreativeGroupAssignment';
  protected $creativeGroupAssignmentsDataType = 'array';
  protected $creativeRotationType = '\GoogleApiServices\Google_Service_Dfareporting_CreativeRotation';
  ...
  protected $defaultClickThroughEventTagPropertiesType = '\GoogleApiServices\Google_Service_Dfareporting_DefaultClickThroughEventTagProperties';
  protected $defaultClickThroughEventTagPropertiesDataType = '';
  protected $deliveryScheduleType = '\GoogleApiServices\Google_Service_Dfareporting_DeliverySchedule';
  protected $deliveryScheduleDataType = '';
  public $dynamicClickTracker;
  public $endTime;
  protected $eventTagOverridesType = '\GoogleApiServices\Google_Service_Dfareporting_EventTagOverride';
  ...
  public $name;
  protected $placementAssignmentsType = '\GoogleApiServices\Google_Service_Dfareporting_PlacementAssignment';
  protected $placementAssignmentsDataType = 'array';
  protected $remarketingListExpressionType = '\GoogleApiServices\Google_Service_Dfareporting_ListTargetingExpression';
