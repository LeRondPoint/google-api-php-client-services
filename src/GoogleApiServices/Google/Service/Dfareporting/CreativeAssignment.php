...
class Google_Service_Dfareporting_CreativeAssignment extends \GoogleApi\Google_Collection
{
  ...
  protected $companionCreativeOverridesType = '\GoogleApiServices\Google_Service_Dfareporting_CompanionClickThroughOverride';
  ...
  public $creativeId;
  protected $creativeIdDimensionValueType = '\GoogleApiServices\Google_Service_Dfareporting_DimensionValue';
  protected $creativeIdDimensionValueDataType = '';
  public $endTime;
  protected $richMediaExitOverridesType = '\GoogleApiServices\Google_Service_Dfareporting_RichMediaExitOverride';
