...
class Google_Service_Dfareporting_Campaign extends \GoogleApi\Google_Collection
{
  protected $collection_key = 'traffickerEmails';
  public $accountId;
  protected $additionalCreativeOptimizationConfigurationsType = '\GoogleApiServices\Google_Service_Dfareporting_CreativeOptimizationConfiguration';
  ...
  public $archived;
  protected $audienceSegmentGroupsType = '\GoogleApiServices\Google_Service_Dfareporting_AudienceSegmentGroup';
  ...
  protected $creativeOptimizationConfigurationType = '\GoogleApiServices\Google_Service_Dfareporting_CreativeOptimizationConfiguration';
