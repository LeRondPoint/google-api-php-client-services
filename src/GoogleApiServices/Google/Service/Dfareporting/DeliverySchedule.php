...
class Google_Service_Dfareporting_DeliverySchedule extends \GoogleApi\Google_Model
{
  protected $frequencyCapType = '\GoogleApiServices\Google_Service_Dfareporting_FrequencyCap';
