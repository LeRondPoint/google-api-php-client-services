...
class Google_Service_Dfareporting_Creative extends \GoogleApi\Google_Collection
{
  ...
  protected $backupImageTargetWindowType = '\GoogleApiServices\Google_Service_Dfareporting_TargetWindow';
  ...
  protected $counterCustomEventsType = '\GoogleApiServices\Google_Service_Dfareporting_CreativeCustomEvent';
  protected $counterCustomEventsDataType = 'array';
  protected $creativeAssetSelectionType = '\GoogleApiServices\Google_Service_Dfareporting_CreativeAssetSelection';
  protected $creativeAssetSelectionDataType = '';
  protected $creativeAssetsType = '\GoogleApiServices\Google_Service_Dfareporting_CreativeAsset';
  protected $creativeAssetsDataType = 'array';
  protected $creativeFieldAssignmentsType = '\GoogleApiServices\Google_Service_Dfareporting_CreativeFieldAssignment';
  protected $creativeFieldAssignmentsDataType = 'array';
  public $customKeyValues;
  public $dynamicAssetSelection;
  protected $exitCustomEventsType = '\GoogleApiServices\Google_Service_Dfareporting_CreativeCustomEvent';
  protected $exitCustomEventsDataType = 'array';
  protected $fsCommandType = '\GoogleApiServices\Google_Service_Dfareporting_FsCommand';
  ...
  public $redirectUrl;
  public $renderingId;
  protected $renderingIdDimensionValueType = '\GoogleApiServices\Google_Service_Dfareporting_DimensionValue';
  protected $renderingIdDimensionValueDataType = '';
  public $requiredFlashPluginVersion;
  public $requiredFlashVersion;
  protected $sizeType = '\GoogleApiServices\Google_Service_Dfareporting_Size';
  ...
  protected $thirdPartyUrlsType = '\GoogleApiServices\Google_Service_Dfareporting_ThirdPartyTrackingUrl';
  protected $thirdPartyUrlsDataType = 'array';
  protected $timerCustomEventsType = '\GoogleApiServices\Google_Service_Dfareporting_CreativeCustomEvent';
