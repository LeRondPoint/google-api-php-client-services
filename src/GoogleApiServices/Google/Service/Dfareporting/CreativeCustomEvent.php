...
class Google_Service_Dfareporting_CreativeCustomEvent extends \GoogleApi\Google_Model
{
  ...
  public $exitUrl;
  public $id;
  protected $popupWindowPropertiesType = '\GoogleApiServices\Google_Service_Dfareporting_PopupWindowProperties';
