...
class Google_Service_Dfareporting_PlacementGroup extends \GoogleApi\Google_Collection
{
  ...
  protected $primaryPlacementIdDimensionValueType = '\GoogleApiServices\Google_Service_Dfareporting_DimensionValue';
