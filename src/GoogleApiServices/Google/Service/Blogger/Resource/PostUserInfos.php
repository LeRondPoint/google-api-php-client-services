 ...
 *  </code>
 */
class Google_Service_Blogger_Resource_PostUserInfos extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($userId, $blogId, $postId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Blogger_PostUserInfo");
  }
  /**
  ...
  public function listPostUserInfos($userId, $blogId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Blogger_PostUserInfosList");
  }
}
