 ...
 *  </code>
 */
class Google_Service_Drive_Resource_Replies extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function create($fileId, $commentId, Google_Service_Drive_Reply $postBody, $optParams = array())
  {
    ...
    return $this->call('create', array($params), "\GoogleApiServices\Google_Service_Drive_Reply");
  }
  /**
  ...
  public function get($fileId, $commentId, $replyId, $optParams = array())
  {
    $params = array('fileId' => $fileId, 'commentId' => $commentId, 'replyId' => $replyId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Drive_Reply");
  }
  /**
  ...
  public function listReplies($fileId, $commentId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Drive_ReplyList");
  }
  /**
  ...
  public function update($fileId, $commentId, $replyId, Google_Service_Drive_Reply $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_Drive_Reply");
  }
}
