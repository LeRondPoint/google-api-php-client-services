 ...
 *  </code>
 */
class Google_Service_Drive_Resource_Comments extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function create($fileId, Google_Service_Drive_Comment $postBody, $optParams = array())
  {
    ...
    return $this->call('create', array($params), "\GoogleApiServices\Google_Service_Drive_Comment");
  }
  /**
  ...
  public function get($fileId, $commentId, $optParams = array())
  {
    $params = array('fileId' => $fileId, 'commentId' => $commentId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Drive_Comment");
  }
  /**
  ...
  public function listComments($fileId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Drive_CommentList");
  }
  /**
  ...
  public function update($fileId, $commentId, Google_Service_Drive_Comment $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_Drive_Comment");
  }
}
