 ...
 *  </code>
 */
class Google_Service_Drive_Resource_Changes extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function getStartPageToken($optParams = array())
  {
    ...
    return $this->call('getStartPageToken', array($params), "\GoogleApiServices\Google_Service_Drive_StartPageToken");
  }
  /**
  ...
  public function listChanges($pageToken, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Drive_ChangeList");
  }
  /**
