 ...
 *  </code>
 */
class Google_Service_AndroidPublisher_Resource_Reviews extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($packageName, $reviewId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_AndroidPublisher_Review");
  }
  /**
  ...
  public function listReviews($packageName, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_AndroidPublisher_ReviewsListResponse");
  }
  /**
  ...
  public function reply($packageName, $reviewId, Google_Service_AndroidPublisher_ReviewsReplyRequest $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('reply', array($params), "\GoogleApiServices\Google_Service_AndroidPublisher_ReviewsReplyResponse");
  }
}
