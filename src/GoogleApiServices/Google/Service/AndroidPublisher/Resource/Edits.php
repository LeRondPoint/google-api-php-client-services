 ...
 *  </code>
 */
class Google_Service_AndroidPublisher_Resource_Edits extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function commit($packageName, $editId, $optParams = array())
  {
    ...
    return $this->call('commit', array($params), "\GoogleApiServices\Google_Service_AndroidPublisher_AppEdit");
  }
  /**
  ...
  public function get($packageName, $editId, $optParams = array())
  {
    $params = array('packageName' => $packageName, 'editId' => $editId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_AndroidPublisher_AppEdit");
  }
  /**
  ...
  public function insert($packageName, Google_Service_AndroidPublisher_AppEdit $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_AndroidPublisher_AppEdit");
  }
  /**
  ...
  public function validate($packageName, $editId, $optParams = array())
  {
    $params = array('packageName' => $packageName, 'editId' => $editId);
    $params = array_merge($params, $optParams);
    return $this->call('validate', array($params), "\GoogleApiServices\Google_Service_AndroidPublisher_AppEdit");
  }
}
