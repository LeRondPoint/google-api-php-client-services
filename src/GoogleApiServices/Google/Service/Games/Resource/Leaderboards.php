 ...
 *  </code>
 */
class Google_Service_Games_Resource_Leaderboards extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($leaderboardId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Games_Leaderboard");
  }
  /**
  ...
  public function listLeaderboards($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Games_LeaderboardListResponse");
  }
}
