 ...
 *  </code>
 */
class Google_Service_Games_Resource_Snapshots extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($snapshotId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Games_Snapshot");
  }
  /**
  ...
  public function listSnapshots($playerId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Games_SnapshotListResponse");
  }
}
