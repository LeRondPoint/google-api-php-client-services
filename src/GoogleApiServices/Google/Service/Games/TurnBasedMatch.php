...
class Google_Service_Games_TurnBasedMatch extends \GoogleApi\Google_Collection
{
  ...
  protected $creationDetailsType = '\GoogleApiServices\Google_Service_Games_TurnBasedMatchModification';
  protected $creationDetailsDataType = '';
  protected $dataType = '\GoogleApiServices\Google_Service_Games_TurnBasedMatchData';
  protected $dataDataType = '';
  public $description;
  public $inviterId;
  public $kind;
  protected $lastUpdateDetailsType = '\GoogleApiServices\Google_Service_Games_TurnBasedMatchModification';
  protected $lastUpdateDetailsDataType = '';
  public $matchId;
  public $matchNumber;
  public $matchVersion;
  protected $participantsType = '\GoogleApiServices\Google_Service_Games_TurnBasedMatchParticipant';
  protected $participantsDataType = 'array';
  public $pendingParticipantId;
  protected $previousMatchDataType = '\GoogleApiServices\Google_Service_Games_TurnBasedMatchData';
