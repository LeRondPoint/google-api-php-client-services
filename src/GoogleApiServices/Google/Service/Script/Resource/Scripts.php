 ...
 *  </code>
 */
class Google_Service_Script_Resource_Scripts extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function run($scriptId, Google_Service_Script_ExecutionRequest $postBody, $optParams = array())
  {
    ...
    return $this->call('run', array($params), "\GoogleApiServices\Google_Service_Script_Operation");
  }
}
