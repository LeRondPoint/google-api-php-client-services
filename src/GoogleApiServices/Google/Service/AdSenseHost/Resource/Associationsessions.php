 ...
 *  </code>
 */
class Google_Service_AdSenseHost_Resource_Associationsessions extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function start($productCode, $websiteUrl, $optParams = array())
  {
    ...
    return $this->call('start', array($params), "\GoogleApiServices\Google_Service_AdSenseHost_AssociationSession");
  }
  /**
  ...
  public function verify($token, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('verify', array($params), "\GoogleApiServices\Google_Service_AdSenseHost_AssociationSession");
  }
}
