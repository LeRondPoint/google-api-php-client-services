 ...
 *  </code>
 */
class Google_Service_AdSenseHost_Resource_Accounts extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($accountId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_AdSenseHost_Account");
  }
  /**
  ...
  public function listAccounts($filterAdClientId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_AdSenseHost_Accounts");
  }
}
