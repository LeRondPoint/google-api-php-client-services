...
class Google_Service_AdSenseHost_AdUnit extends \GoogleApi\Google_Model
{
  public $code;
  protected $contentAdsSettingsType = '\GoogleApiServices\Google_Service_AdSenseHost_AdUnitContentAdsSettings';
  protected $contentAdsSettingsDataType = '';
  protected $customStyleType = '\GoogleApiServices\Google_Service_AdSenseHost_AdStyle';
  protected $customStyleDataType = '';
  public $id;
  public $kind;
  protected $mobileContentAdsSettingsType = '\GoogleApiServices\Google_Service_AdSenseHost_AdUnitMobileContentAdsSettings';
