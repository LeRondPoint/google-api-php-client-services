 ...
 *  </code>
 */
class Google_Service_Vision_Resource_Images extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function annotate(Google_Service_Vision_BatchAnnotateImagesRequest $postBody, $optParams = array())
  {
    ...
    return $this->call('annotate', array($params), "\GoogleApiServices\Google_Service_Vision_BatchAnnotateImagesResponse");
  }
}
