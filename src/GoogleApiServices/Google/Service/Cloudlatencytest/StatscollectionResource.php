 ...
 *  </code>
 */
class Google_Service_Cloudlatencytest_StatscollectionResource extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function updateaggregatedstats(Google_Service_Cloudlatencytest_AggregatedStats $postBody, $optParams = array())
  {
    ...
    return $this->call('updateaggregatedstats', array($params), "\GoogleApiServices\Google_Service_Cloudlatencytest_AggregatedStatsReply");
  }
  /**
  ...
  public function updatestats(Google_Service_Cloudlatencytest_Stats $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('updatestats', array($params), "\GoogleApiServices\Google_Service_Cloudlatencytest_StatsReply");
  }
}
