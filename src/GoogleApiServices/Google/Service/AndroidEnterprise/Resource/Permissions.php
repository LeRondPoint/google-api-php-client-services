 ...
 *  </code>
 */
class Google_Service_AndroidEnterprise_Resource_Permissions extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($permissionId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_AndroidEnterprise_Permission");
  }
}
