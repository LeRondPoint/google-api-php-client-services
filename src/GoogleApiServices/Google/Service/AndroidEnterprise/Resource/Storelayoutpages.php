 ...
 *  </code>
 */
class Google_Service_AndroidEnterprise_Resource_Storelayoutpages extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($enterpriseId, $pageId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'pageId' => $pageId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_AndroidEnterprise_StorePage");
  }
  /**
  ...
  public function insert($enterpriseId, Google_Service_AndroidEnterprise_StorePage $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_AndroidEnterprise_StorePage");
  }
  /**
  ...
  public function listStorelayoutpages($enterpriseId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_AndroidEnterprise_StoreLayoutPagesListResponse");
  }
  /**
  ...
  public function patch($enterpriseId, $pageId, Google_Service_AndroidEnterprise_StorePage $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "\GoogleApiServices\Google_Service_AndroidEnterprise_StorePage");
  }
  /**
  ...
  public function update($enterpriseId, $pageId, Google_Service_AndroidEnterprise_StorePage $postBody, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'pageId' => $pageId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_AndroidEnterprise_StorePage");
  }
}
