 ...
 *  </code>
 */
class Google_Service_AndroidEnterprise_Resource_Collectionviewers extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listCollectionviewers($enterpriseId, $collectionId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_AndroidEnterprise_CollectionViewersListResponse");
  }
  /**
