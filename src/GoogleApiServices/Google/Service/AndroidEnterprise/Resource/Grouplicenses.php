 ...
 *  </code>
 */
class Google_Service_AndroidEnterprise_Resource_Grouplicenses extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($enterpriseId, $groupLicenseId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_AndroidEnterprise_GroupLicense");
  }
  /**
  ...
  public function listGrouplicenses($enterpriseId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_AndroidEnterprise_GroupLicensesListResponse");
  }
}
