 ...
 *  </code>
 */
class Google_Service_Logging_Resource_ProjectsMetrics extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function create($projectName, Google_Service_Logging_LogMetric $postBody, $optParams = array())
  {
    ...
    return $this->call('create', array($params), "\GoogleApiServices\Google_Service_Logging_LogMetric");
  }
  /**
  ...
  public function get($metricName, $optParams = array())
  {
    $params = array('metricName' => $metricName);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Logging_LogMetric");
  }
  /**
  ...
  public function listProjectsMetrics($projectName, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Logging_ListLogMetricsResponse");
  }
  /**
  ...
  public function update($metricName, Google_Service_Logging_LogMetric $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_Logging_LogMetric");
  }
}
