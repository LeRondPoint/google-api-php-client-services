 ...
 *  </code>
 */
class Google_Service_Logging_Resource_MonitoredResourceDescriptors extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listMonitoredResourceDescriptors($optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Logging_ListMonitoredResourceDescriptorsResponse");
  }
}
