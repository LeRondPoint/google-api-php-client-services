 ...
 * @author Google, Inc.
 */
class Google_Service_Freebase extends \GoogleApi\Google_Service
{
  ...
  public function reconcile($optParams = array())
  {
    ...
    return $this->base_methods->call('reconcile', array($params), "\GoogleApiServices\Google_Service_Freebase_ReconcileGet");
  }
  /**
