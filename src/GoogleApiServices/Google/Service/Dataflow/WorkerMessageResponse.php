...
class Google_Service_Dataflow_WorkerMessageResponse extends \GoogleApi\Google_Model
{
  protected $workerHealthReportResponseType = '\GoogleApiServices\Google_Service_Dataflow_WorkerHealthReportResponse';
