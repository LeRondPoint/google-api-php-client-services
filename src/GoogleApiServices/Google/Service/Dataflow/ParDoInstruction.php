...
class Google_Service_Dataflow_ParDoInstruction extends \GoogleApi\Google_Collection
{
  protected $collection_key = 'sideInputs';
  protected $inputType = '\GoogleApiServices\Google_Service_Dataflow_InstructionInput';
  protected $inputDataType = '';
  protected $multiOutputInfosType = '\GoogleApiServices\Google_Service_Dataflow_MultiOutputInfo';
