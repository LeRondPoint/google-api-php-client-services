 ...
 *  </code>
 */
class Google_Service_Dataflow_Resource_ProjectsJobsMessages extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listProjectsJobsMessages($projectId, $jobId, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Dataflow_ListJobMessagesResponse");
  }
}
