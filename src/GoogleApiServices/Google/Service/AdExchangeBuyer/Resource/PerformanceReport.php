 ...
 *  </code>
 */
class Google_Service_AdExchangeBuyer_Resource_PerformanceReport extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listPerformanceReport($accountId, $endDateTime, $startDateTime, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_AdExchangeBuyer_PerformanceReportList");
  }
}
