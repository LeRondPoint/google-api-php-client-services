 ...
 *  </code>
 */
class Google_Service_AdExchangeBuyer_Resource_Creatives extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($accountId, $buyerCreativeId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_AdExchangeBuyer_Creative");
  }
  /**
  ...
  public function insert(Google_Service_AdExchangeBuyer_Creative $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_AdExchangeBuyer_Creative");
  }
  /**
  ...
  public function listCreatives($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_AdExchangeBuyer_CreativesList");
  }
  /**
