 ...
 *  </code>
 */
class Google_Service_AdExchangeBuyer_Resource_Pubprofiles extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listPubprofiles($accountId, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_AdExchangeBuyer_GetPublisherProfilesByAccountIdResponse");
  }
}
