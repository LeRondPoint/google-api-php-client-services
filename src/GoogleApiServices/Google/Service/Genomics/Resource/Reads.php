 ...
 *  </code>
 */
class Google_Service_Genomics_Resource_Reads extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function search(Google_Service_Genomics_SearchReadsRequest $postBody, $optParams = array())
  {
    ...
    return $this->call('search', array($params), "\GoogleApiServices\Google_Service_Genomics_SearchReadsResponse");
  }
  /**
  ...
  public function stream(Google_Service_Genomics_StreamReadsRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('stream', array($params), "\GoogleApiServices\Google_Service_Genomics_StreamReadsResponse");
  }
}
