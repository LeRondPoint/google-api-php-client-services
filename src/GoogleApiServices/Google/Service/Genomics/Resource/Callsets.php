 ...
 *  </code>
 */
class Google_Service_Genomics_Resource_Callsets extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function create(Google_Service_Genomics_CallSet $postBody, $optParams = array())
  {
    ...
    return $this->call('create', array($params), "\GoogleApiServices\Google_Service_Genomics_CallSet");
  }
  /**
  ...
  public function get($callSetId, $optParams = array())
  {
    $params = array('callSetId' => $callSetId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Genomics_CallSet");
  }
  /**
  ...
  public function patch($callSetId, Google_Service_Genomics_CallSet $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "\GoogleApiServices\Google_Service_Genomics_CallSet");
  }
  /**
  ...
  public function search(Google_Service_Genomics_SearchCallSetsRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "\GoogleApiServices\Google_Service_Genomics_SearchCallSetsResponse");
  }
}
