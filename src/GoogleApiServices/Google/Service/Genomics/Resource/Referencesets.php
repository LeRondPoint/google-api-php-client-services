 ...
 *  </code>
 */
class Google_Service_Genomics_Resource_Referencesets extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($referenceSetId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Genomics_ReferenceSet");
  }
  /**
  ...
  public function search(Google_Service_Genomics_SearchReferenceSetsRequest $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "\GoogleApiServices\Google_Service_Genomics_SearchReferenceSetsResponse");
  }
}
