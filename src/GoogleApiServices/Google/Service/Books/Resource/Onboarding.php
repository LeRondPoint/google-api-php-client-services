 ...
 *  </code>
 */
class Google_Service_Books_Resource_Onboarding extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listCategories($optParams = array())
  {
    ...
    return $this->call('listCategories', array($params), "\GoogleApiServices\Google_Service_Books_Category");
  }
  /**
  ...
  public function listCategoryVolumes($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('listCategoryVolumes', array($params), "\GoogleApiServices\Google_Service_Books_Volume2");
  }
}
