 ...
 *  </code>
 */
class Google_Service_Books_Resource_Layers extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($volumeId, $summaryId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Books_Layersummary");
  }
  /**
  ...
  public function listLayers($volumeId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Books_Layersummaries");
  }
}
