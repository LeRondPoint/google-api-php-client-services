 ...
 *  </code>
 */
class Google_Service_Books_Resource_Notification extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($notificationId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Books_Notification");
  }
}
