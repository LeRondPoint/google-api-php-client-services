 ...
 *  </code>
 */
class Google_Service_Books_Resource_Series extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($seriesId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Books_Series");
  }
}
