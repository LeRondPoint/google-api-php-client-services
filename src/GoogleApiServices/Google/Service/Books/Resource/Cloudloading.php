 ...
 *  </code>
 */
class Google_Service_Books_Resource_Cloudloading extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function addBook($optParams = array())
  {
    ...
    return $this->call('addBook', array($params), "\GoogleApiServices\Google_Service_Books_BooksCloudloadingResource");
  }
  /**
  ...
  public function updateBook(Google_Service_Books_BooksCloudloadingResource $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('updateBook', array($params), "\GoogleApiServices\Google_Service_Books_BooksCloudloadingResource");
  }
}
