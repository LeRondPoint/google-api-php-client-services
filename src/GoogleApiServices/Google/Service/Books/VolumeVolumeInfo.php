...
class Google_Service_Books_VolumeVolumeInfo extends \GoogleApi\Google_Collection
{
  ...
  public $description;
  protected $dimensionsType = '\GoogleApiServices\Google_Service_Books_VolumeVolumeInfoDimensions';
  protected $dimensionsDataType = '';
  protected $imageLinksType = '\GoogleApiServices\Google_Service_Books_VolumeVolumeInfoImageLinks';
  protected $imageLinksDataType = '';
  protected $industryIdentifiersType = '\GoogleApiServices\Google_Service_Books_VolumeVolumeInfoIndustryIdentifiers';
  ...
  public $pageCount;
  protected $panelizationSummaryType = '\GoogleApiServices\Google_Service_Books_VolumeVolumeInfoPanelizationSummary';
  ...
  protected $seriesInfoType = '\GoogleApiServices\Google_Service_Books_Volumeseriesinfo';
