 ...
 *  </code>
 */
class Google_Service_Dns_Resource_ResourceRecordSets extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listResourceRecordSets($project, $managedZone, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Dns_ResourceRecordSetsListResponse");
  }
}
