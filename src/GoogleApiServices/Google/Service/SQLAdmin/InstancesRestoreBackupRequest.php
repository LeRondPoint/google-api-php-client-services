...
class Google_Service_SQLAdmin_InstancesRestoreBackupRequest extends \GoogleApi\Google_Model
{
  protected $restoreBackupContextType = '\GoogleApiServices\Google_Service_SQLAdmin_RestoreBackupContext';
