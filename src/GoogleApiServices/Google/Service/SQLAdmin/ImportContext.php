...
class Google_Service_SQLAdmin_ImportContext extends \GoogleApi\Google_Model
{
  protected $csvImportOptionsType = '\GoogleApiServices\Google_Service_SQLAdmin_ImportContextCsvImportOptions';
