 ...
 *  </code>
 */
class Google_Service_SQLAdmin_Resource_Flags extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listFlags($optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_SQLAdmin_FlagsListResponse");
  }
}
