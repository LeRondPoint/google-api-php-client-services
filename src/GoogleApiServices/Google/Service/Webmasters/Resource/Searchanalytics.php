 ...
 *  </code>
 */
class Google_Service_Webmasters_Resource_Searchanalytics extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function query($siteUrl, Google_Service_Webmasters_SearchAnalyticsQueryRequest $postBody, $optParams = array())
  {
    ...
    return $this->call('query', array($params), "\GoogleApiServices\Google_Service_Webmasters_SearchAnalyticsQueryResponse");
  }
}
