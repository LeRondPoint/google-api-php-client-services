 ...
 *  </code>
 */
class Google_Service_Webmasters_Resource_Urlcrawlerrorssamples extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($siteUrl, $url, $category, $platform, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Webmasters_UrlCrawlErrorsSample");
  }
  /**
  ...
  public function listUrlcrawlerrorssamples($siteUrl, $category, $platform, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Webmasters_UrlCrawlErrorsSamplesListResponse");
  }
  /**
