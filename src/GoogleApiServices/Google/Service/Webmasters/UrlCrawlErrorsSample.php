...
class Google_Service_Webmasters_UrlCrawlErrorsSample extends \GoogleApi\Google_Model
{
  ...
  public $pageUrl;
  public $responseCode;
  protected $urlDetailsType = '\GoogleApiServices\Google_Service_Webmasters_UrlSampleDetails';
