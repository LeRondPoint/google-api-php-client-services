 ...
 *  </code>
 */
class Google_Service_Doubleclicksearch_Resource_SavedColumns extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listSavedColumns($agencyId, $advertiserId, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Doubleclicksearch_SavedColumnList");
  }
}
