 ...
 *  </code>
 */
class Google_Service_AdExchangeSeller_Resource_AccountsMetadataDimensions extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listAccountsMetadataDimensions($accountId, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_AdExchangeSeller_Metadata");
  }
}
