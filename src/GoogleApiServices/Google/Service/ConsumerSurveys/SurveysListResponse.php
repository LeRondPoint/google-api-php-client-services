...
class Google_Service_ConsumerSurveys_SurveysListResponse extends \GoogleApi\Google_Collection
{
  protected $collection_key = 'resources';
  protected $pageInfoType = '\GoogleApiServices\Google_Service_ConsumerSurveys_PageInfo';
  protected $pageInfoDataType = '';
  public $requestId;
  protected $resourcesType = '\GoogleApiServices\Google_Service_ConsumerSurveys_Survey';
