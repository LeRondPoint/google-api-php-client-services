 ...
 *  </code>
 */
class Google_Service_Proximitybeacon_Resource_Namespaces extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listNamespaces($optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Proximitybeacon_ListNamespacesResponse");
  }
  /**
  ...
  public function update($namespaceName, Google_Service_Proximitybeacon_ProximitybeaconNamespace $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_Proximitybeacon_ProximitybeaconNamespace");
  }
}
