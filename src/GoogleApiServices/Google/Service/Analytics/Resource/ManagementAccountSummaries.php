 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementAccountSummaries extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listManagementAccountSummaries($optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Analytics_AccountSummaries");
  }
}
