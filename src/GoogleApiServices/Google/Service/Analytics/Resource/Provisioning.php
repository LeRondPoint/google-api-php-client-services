 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_Provisioning extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function createAccountTicket(Google_Service_Analytics_AccountTicket $postBody, $optParams = array())
  {
    ...
    return $this->call('createAccountTicket', array($params), "\GoogleApiServices\Google_Service_Analytics_AccountTicket");
  }
}
