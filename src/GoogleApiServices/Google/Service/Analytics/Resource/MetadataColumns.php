 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_MetadataColumns extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listMetadataColumns($reportType, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Analytics_Columns");
  }
}
