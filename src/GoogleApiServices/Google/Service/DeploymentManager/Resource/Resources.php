 ...
 *  </code>
 */
class Google_Service_DeploymentManager_Resource_Resources extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($project, $deployment, $resource, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_DeploymentManager_DeploymentmanagerResource");
  }
  /**
  ...
  public function listResources($project, $deployment, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_DeploymentManager_ResourcesListResponse");
  }
}
