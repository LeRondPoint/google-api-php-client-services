 ...
 *  </code>
 */
class Google_Service_DeploymentManager_Resource_Types extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listTypes($project, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_DeploymentManager_TypesListResponse");
  }
}
