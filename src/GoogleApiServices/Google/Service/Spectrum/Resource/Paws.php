 ...
 *  </code>
 */
class Google_Service_Spectrum_Resource_Paws extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function getSpectrum(Google_Service_Spectrum_PawsGetSpectrumRequest $postBody, $optParams = array())
  {
    ...
    return $this->call('getSpectrum', array($params), "\GoogleApiServices\Google_Service_Spectrum_PawsGetSpectrumResponse");
  }
  /**
  ...
  public function getSpectrumBatch(Google_Service_Spectrum_PawsGetSpectrumBatchRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('getSpectrumBatch', array($params), "\GoogleApiServices\Google_Service_Spectrum_PawsGetSpectrumBatchResponse");
  }
  /**
  ...
  public function init(Google_Service_Spectrum_PawsInitRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('init', array($params), "\GoogleApiServices\Google_Service_Spectrum_PawsInitResponse");
  }
  /**
  ...
  public function notifySpectrumUse(Google_Service_Spectrum_PawsNotifySpectrumUseRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('notifySpectrumUse', array($params), "\GoogleApiServices\Google_Service_Spectrum_PawsNotifySpectrumUseResponse");
  }
  /**
  ...
  public function register(Google_Service_Spectrum_PawsRegisterRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('register', array($params), "\GoogleApiServices\Google_Service_Spectrum_PawsRegisterResponse");
  }
  /**
  ...
  public function verifyDevice(Google_Service_Spectrum_PawsVerifyDeviceRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('verifyDevice', array($params), "\GoogleApiServices\Google_Service_Spectrum_PawsVerifyDeviceResponse");
  }
}
