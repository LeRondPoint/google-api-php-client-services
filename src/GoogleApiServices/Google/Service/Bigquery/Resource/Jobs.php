 ...
 *  </code>
 */
class Google_Service_Bigquery_Resource_Jobs extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function cancel($projectId, $jobId, $optParams = array())
  {
    ...
    return $this->call('cancel', array($params), "\GoogleApiServices\Google_Service_Bigquery_JobCancelResponse");
  }
  /**
  ...
  public function get($projectId, $jobId, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'jobId' => $jobId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Bigquery_Job");
  }
  /**
  ...
  public function getQueryResults($projectId, $jobId, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'jobId' => $jobId);
    $params = array_merge($params, $optParams);
    return $this->call('getQueryResults', array($params), "\GoogleApiServices\Google_Service_Bigquery_GetQueryResultsResponse");
  }
  /**
  ...
  public function insert($projectId, Google_Service_Bigquery_Job $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_Bigquery_Job");
  }
  /**
  ...
  public function listJobs($projectId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Bigquery_JobList");
  }
  /**
  ...
  public function query($projectId, Google_Service_Bigquery_QueryRequest $postBody, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "\GoogleApiServices\Google_Service_Bigquery_QueryResponse");
  }
}
