 ...
 *  </code>
 */
class Google_Service_Bigquery_Resource_Tabledata extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function insertAll($projectId, $datasetId, $tableId, Google_Service_Bigquery_TableDataInsertAllRequest $postBody, $optParams = array())
  {
    ...
    return $this->call('insertAll', array($params), "\GoogleApiServices\Google_Service_Bigquery_TableDataInsertAllResponse");
  }
  /**
  ...
  public function listTabledata($projectId, $datasetId, $tableId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Bigquery_TableDataList");
  }
}
