...
class Google_Service_YouTube_SponsorListResponse extends \GoogleApi\Google_Collection
{
  protected $collection_key = 'items';
  public $etag;
  public $eventId;
  protected $itemsType = '\GoogleApiServices\Google_Service_YouTube_Sponsor';
