 ...
 *  </code>
 */
class Google_Service_YouTube_Resource_Search extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listSearch($part, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_YouTube_SearchListResponse");
  }
}
