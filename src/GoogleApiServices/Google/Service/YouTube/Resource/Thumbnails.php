 ...
 *  </code>
 */
class Google_Service_YouTube_Resource_Thumbnails extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function set($videoId, $optParams = array())
  {
    ...
    return $this->call('set', array($params), "\GoogleApiServices\Google_Service_YouTube_ThumbnailSetResponse");
  }
}
