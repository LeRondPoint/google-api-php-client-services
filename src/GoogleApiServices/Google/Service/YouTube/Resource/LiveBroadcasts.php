 ...
 *  </code>
 */
class Google_Service_YouTube_Resource_LiveBroadcasts extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function bind($id, $part, $optParams = array())
  {
    ...
    return $this->call('bind', array($params), "\GoogleApiServices\Google_Service_YouTube_LiveBroadcast");
  }
  /**
  ...
  public function control($id, $part, $optParams = array())
  {
    $params = array('id' => $id, 'part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('control', array($params), "\GoogleApiServices\Google_Service_YouTube_LiveBroadcast");
  }
  /**
  ...
  public function insert($part, Google_Service_YouTube_LiveBroadcast $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_YouTube_LiveBroadcast");
  }
  /**
  ...
  public function listLiveBroadcasts($part, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_YouTube_LiveBroadcastListResponse");
  }
  /**
  ...
  public function transition($broadcastStatus, $id, $part, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('transition', array($params), "\GoogleApiServices\Google_Service_YouTube_LiveBroadcast");
  }
  /**
  ...
  public function update($part, Google_Service_YouTube_LiveBroadcast $postBody, $optParams = array())
  {
    $params = array('part' => $part, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_YouTube_LiveBroadcast");
  }
}
