 ...
 *  </code>
 */
class Google_Service_YouTube_Resource_FanFundingEvents extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listFanFundingEvents($part, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_YouTube_FanFundingEventListResponse");
  }
}
