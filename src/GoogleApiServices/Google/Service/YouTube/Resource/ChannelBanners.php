 ...
 *  </code>
 */
class Google_Service_YouTube_Resource_ChannelBanners extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function insert(Google_Service_YouTube_ChannelBannerResource $postBody, $optParams = array())
  {
    ...
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_YouTube_ChannelBannerResource");
  }
}
