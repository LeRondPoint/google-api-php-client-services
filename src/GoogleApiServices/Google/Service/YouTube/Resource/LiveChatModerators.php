 ...
 *  </code>
 */
class Google_Service_YouTube_Resource_LiveChatModerators extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function insert($part, Google_Service_YouTube_LiveChatModerator $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_YouTube_LiveChatModerator");
  }
  /**
  ...
  public function listLiveChatModerators($liveChatId, $part, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_YouTube_LiveChatModeratorListResponse");
  }
}
