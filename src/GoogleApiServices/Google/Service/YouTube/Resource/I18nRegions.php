 ...
 *  </code>
 */
class Google_Service_YouTube_Resource_I18nRegions extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listI18nRegions($part, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_YouTube_I18nRegionListResponse");
  }
}
