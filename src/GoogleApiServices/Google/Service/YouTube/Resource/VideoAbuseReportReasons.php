 ...
 *  </code>
 */
class Google_Service_YouTube_Resource_VideoAbuseReportReasons extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listVideoAbuseReportReasons($part, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_YouTube_VideoAbuseReportReasonListResponse");
  }
}
