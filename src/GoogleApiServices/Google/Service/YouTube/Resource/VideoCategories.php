 ...
 *  </code>
 */
class Google_Service_YouTube_Resource_VideoCategories extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listVideoCategories($part, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_YouTube_VideoCategoryListResponse");
  }
}
