 ...
 *  </code>
 */
class Google_Service_YouTube_Resource_GuideCategories extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listGuideCategories($part, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_YouTube_GuideCategoryListResponse");
  }
}
