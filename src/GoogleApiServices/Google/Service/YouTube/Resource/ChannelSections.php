 ...
 *  </code>
 */
class Google_Service_YouTube_Resource_ChannelSections extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function insert($part, Google_Service_YouTube_ChannelSection $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_YouTube_ChannelSection");
  }
  /**
  ...
  public function listChannelSections($part, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_YouTube_ChannelSectionListResponse");
  }
  /**
  ...
  public function update($part, Google_Service_YouTube_ChannelSection $postBody, $optParams = array())
  {
    $params = array('part' => $part, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_YouTube_ChannelSection");
  }
}
