 ...
 *  </code>
 */
class Google_Service_Fusiontables_Resource_Table extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function copy($tableId, $optParams = array())
  {
    ...
    return $this->call('copy', array($params), "\GoogleApiServices\Google_Service_Fusiontables_Table");
  }
  /**
  ...
  public function get($tableId, $optParams = array())
  {
    $params = array('tableId' => $tableId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Fusiontables_Table");
  }
  /**
  ...
  public function importRows($tableId, $optParams = array())
  {
    $params = array('tableId' => $tableId);
    $params = array_merge($params, $optParams);
    return $this->call('importRows', array($params), "\GoogleApiServices\Google_Service_Fusiontables_Import");
  }
  /**
  ...
  public function importTable($name, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('importTable', array($params), "\GoogleApiServices\Google_Service_Fusiontables_Table");
  }
  /**
  ...
  public function insert(Google_Service_Fusiontables_Table $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_Fusiontables_Table");
  }
  /**
  ...
  public function listTable($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Fusiontables_TableList");
  }
  /**
  ...
  public function patch($tableId, Google_Service_Fusiontables_Table $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "\GoogleApiServices\Google_Service_Fusiontables_Table");
  }
  /**
  ...
  public function replaceRows($tableId, $optParams = array())
  {
    $params = array('tableId' => $tableId);
    $params = array_merge($params, $optParams);
    return $this->call('replaceRows', array($params), "\GoogleApiServices\Google_Service_Fusiontables_Task");
  }
  /**
   * Updates an existing table. Unless explicitly requested, only the name,
  ...
  public function update($tableId, Google_Service_Fusiontables_Table $postBody, $optParams = array())
  {
    $params = array('tableId' => $tableId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_Fusiontables_Table");
  }
}
