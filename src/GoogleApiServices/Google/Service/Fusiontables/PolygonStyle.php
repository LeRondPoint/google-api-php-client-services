...
class Google_Service_Fusiontables_PolygonStyle extends \GoogleApi\Google_Model
{
  public $fillColor;
  protected $fillColorStylerType = '\GoogleApiServices\Google_Service_Fusiontables_StyleFunction';
