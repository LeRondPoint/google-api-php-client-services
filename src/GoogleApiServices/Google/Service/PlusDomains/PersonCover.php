...
class Google_Service_PlusDomains_PersonCover extends \GoogleApi\Google_Model
{
  protected $coverInfoType = '\GoogleApiServices\Google_Service_PlusDomains_PersonCoverCoverInfo';
  protected $coverInfoDataType = '';
  protected $coverPhotoType = '\GoogleApiServices\Google_Service_PlusDomains_PersonCoverCoverPhoto';
