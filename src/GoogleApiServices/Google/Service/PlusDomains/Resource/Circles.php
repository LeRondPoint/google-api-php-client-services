 ...
 *  </code>
 */
class Google_Service_PlusDomains_Resource_Circles extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function addPeople($circleId, $optParams = array())
  {
    ...
    return $this->call('addPeople', array($params), "\GoogleApiServices\Google_Service_PlusDomains_Circle");
  }
  /**
  ...
  public function get($circleId, $optParams = array())
  {
    $params = array('circleId' => $circleId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_PlusDomains_Circle");
  }
  /**
  ...
  public function insert($userId, Google_Service_PlusDomains_Circle $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_PlusDomains_Circle");
  }
  /**
  ...
  public function listCircles($userId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_PlusDomains_CircleFeed");
  }
  /**
  ...
  public function patch($circleId, Google_Service_PlusDomains_Circle $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "\GoogleApiServices\Google_Service_PlusDomains_Circle");
  }
  /**
  ...
  public function update($circleId, Google_Service_PlusDomains_Circle $postBody, $optParams = array())
  {
    $params = array('circleId' => $circleId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_PlusDomains_Circle");
  }
}
