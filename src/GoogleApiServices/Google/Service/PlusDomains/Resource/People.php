 ...
 *  </code>
 */
class Google_Service_PlusDomains_Resource_People extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($userId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_PlusDomains_Person");
  }
  /**
  ...
  public function listPeople($userId, $collection, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_PlusDomains_PeopleFeed");
  }
  /**
  ...
  public function listByActivity($activityId, $collection, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('listByActivity', array($params), "\GoogleApiServices\Google_Service_PlusDomains_PeopleFeed");
  }
  /**
  ...
  public function listByCircle($circleId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('listByCircle', array($params), "\GoogleApiServices\Google_Service_PlusDomains_PeopleFeed");
  }
}
