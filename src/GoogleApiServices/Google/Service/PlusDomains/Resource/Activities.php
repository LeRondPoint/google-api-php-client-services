 ...
 *  </code>
 */
class Google_Service_PlusDomains_Resource_Activities extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($activityId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_PlusDomains_Activity");
  }
  /**
  ...
  public function insert($userId, Google_Service_PlusDomains_Activity $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_PlusDomains_Activity");
  }
  /**
  ...
  public function listActivities($userId, $collection, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_PlusDomains_ActivityFeed");
  }
}
