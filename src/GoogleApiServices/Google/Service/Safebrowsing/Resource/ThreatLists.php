 ...
 *  </code>
 */
class Google_Service_Safebrowsing_Resource_ThreatLists extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listThreatLists($optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Safebrowsing_ListThreatListsResponse");
  }
}
