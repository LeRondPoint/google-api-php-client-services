 ...
 *  </code>
 */
class Google_Service_Safebrowsing_Resource_ThreatMatches extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function find(Google_Service_Safebrowsing_FindThreatMatchesRequest $postBody, $optParams = array())
  {
    ...
    return $this->call('find', array($params), "\GoogleApiServices\Google_Service_Safebrowsing_FindThreatMatchesResponse");
  }
}
