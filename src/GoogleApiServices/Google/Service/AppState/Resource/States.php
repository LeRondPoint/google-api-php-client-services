 ...
 *  </code>
 */
class Google_Service_AppState_Resource_States extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function clear($stateKey, $optParams = array())
  {
    ...
    return $this->call('clear', array($params), "\GoogleApiServices\Google_Service_AppState_WriteResult");
  }
  /**
  ...
  public function get($stateKey, $optParams = array())
  {
    $params = array('stateKey' => $stateKey);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_AppState_GetResponse");
  }
  /**
  ...
  public function listStates($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_AppState_ListResponse");
  }
  /**
  ...
  public function update($stateKey, Google_Service_AppState_UpdateRequest $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_AppState_WriteResult");
  }
}
