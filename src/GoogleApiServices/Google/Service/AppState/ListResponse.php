...
class Google_Service_AppState_ListResponse extends \GoogleApi\Google_Collection
{
  protected $collection_key = 'items';
  protected $itemsType = '\GoogleApiServices\Google_Service_AppState_GetResponse';
