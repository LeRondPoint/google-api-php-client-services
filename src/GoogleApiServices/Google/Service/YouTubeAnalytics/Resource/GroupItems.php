 ...
 *  </code>
 */
class Google_Service_YouTubeAnalytics_Resource_GroupItems extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function insert(Google_Service_YouTubeAnalytics_GroupItem $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_YouTubeAnalytics_GroupItem");
  }
  /**
  ...
  public function listGroupItems($groupId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_YouTubeAnalytics_GroupItemListResponse");
  }
}
