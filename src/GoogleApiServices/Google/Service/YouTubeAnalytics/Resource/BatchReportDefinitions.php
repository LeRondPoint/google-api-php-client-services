 ...
 *  </code>
 */
class Google_Service_YouTubeAnalytics_Resource_BatchReportDefinitions extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listBatchReportDefinitions($onBehalfOfContentOwner, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_YouTubeAnalytics_BatchReportDefinitionList");
  }
}
