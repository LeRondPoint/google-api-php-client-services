 ...
 *  </code>
 */
class Google_Service_PlayMovies_Resource_AccountsStoreInfosCountry extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($accountId, $videoId, $country, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_PlayMovies_StoreInfo");
  }
}
