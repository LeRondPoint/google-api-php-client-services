 ...
 *  </code>
 */
class Google_Service_PlayMovies_Resource_AccountsExperienceLocales extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($accountId, $elId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_PlayMovies_ExperienceLocale");
  }
  /**
  ...
  public function listAccountsExperienceLocales($accountId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_PlayMovies_ListExperienceLocalesResponse");
  }
}
