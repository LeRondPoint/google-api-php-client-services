 ...
 *  </code>
 */
class Google_Service_PlayMovies_Resource_AccountsStoreInfos extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listAccountsStoreInfos($accountId, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_PlayMovies_ListStoreInfosResponse");
  }
}
