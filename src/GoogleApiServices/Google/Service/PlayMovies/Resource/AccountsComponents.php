 ...
 *  </code>
 */
class Google_Service_PlayMovies_Resource_AccountsComponents extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listAccountsComponents($accountId, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_PlayMovies_ListComponentsResponse");
  }
}
