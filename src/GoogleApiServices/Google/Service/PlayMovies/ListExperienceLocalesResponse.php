...
class Google_Service_PlayMovies_ListExperienceLocalesResponse extends \GoogleApi\Google_Collection
{
  protected $collection_key = 'experienceLocales';
  protected $experienceLocalesType = '\GoogleApiServices\Google_Service_PlayMovies_ExperienceLocale';
