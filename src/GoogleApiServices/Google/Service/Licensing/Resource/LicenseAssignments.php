 ...
 *  </code>
 */
class Google_Service_Licensing_Resource_LicenseAssignments extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($productId, $skuId, $userId, $optParams = array())
  {
    $params = array('productId' => $productId, 'skuId' => $skuId, 'userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Licensing_LicenseAssignment");
  }
  /**
  ...
  public function insert($productId, $skuId, Google_Service_Licensing_LicenseAssignmentInsert $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\GoogleApiServices\Google_Service_Licensing_LicenseAssignment");
  }
  /**
  ...
  public function listForProduct($productId, $customerId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('listForProduct', array($params), "\GoogleApiServices\Google_Service_Licensing_LicenseAssignmentList");
  }
  /**
  ...
  public function listForProductAndSku($productId, $skuId, $customerId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('listForProductAndSku', array($params), "\GoogleApiServices\Google_Service_Licensing_LicenseAssignmentList");
  }
  /**
  ...
  public function patch($productId, $skuId, $userId, Google_Service_Licensing_LicenseAssignment $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "\GoogleApiServices\Google_Service_Licensing_LicenseAssignment");
  }
  /**
  ...
  public function update($productId, $skuId, $userId, Google_Service_Licensing_LicenseAssignment $postBody, $optParams = array())
  {
    $params = array('productId' => $productId, 'skuId' => $skuId, 'userId' => $userId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\GoogleApiServices\Google_Service_Licensing_LicenseAssignment");
  }
}
