 ...
 *  </code>
 */
class Google_Service_People_Resource_People extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function get($resourceName, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_People_Person");
  }
  /**
  ...
  public function getBatchGet($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('getBatchGet', array($params), "\GoogleApiServices\Google_Service_People_GetPeopleResponse");
  }
}
