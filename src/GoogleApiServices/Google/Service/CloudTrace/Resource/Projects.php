 ...
 *  </code>
 */
class Google_Service_CloudTrace_Resource_Projects extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function patchTraces($projectId, Google_Service_CloudTrace_Traces $postBody, $optParams = array())
  {
    ...
    return $this->call('patchTraces', array($params), "\GoogleApiServices\Google_Service_CloudTrace_CloudtraceEmpty");
  }
}
