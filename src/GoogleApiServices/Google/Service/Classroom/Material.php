...
class Google_Service_Classroom_Material extends \GoogleApi\Google_Model
{
  protected $driveFileType = '\GoogleApiServices\Google_Service_Classroom_SharedDriveFile';
