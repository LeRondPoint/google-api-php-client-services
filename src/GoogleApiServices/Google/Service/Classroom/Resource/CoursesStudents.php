 ...
 *  </code>
 */
class Google_Service_Classroom_Resource_CoursesStudents extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function create($courseId, Google_Service_Classroom_Student $postBody, $optParams = array())
  {
    ...
    return $this->call('create', array($params), "\GoogleApiServices\Google_Service_Classroom_Student");
  }
  /**
  ...
  public function get($courseId, $userId, $optParams = array())
  {
    $params = array('courseId' => $courseId, 'userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Classroom_Student");
  }
  /**
  ...
  public function listCoursesStudents($courseId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Classroom_ListStudentsResponse");
  }
}
