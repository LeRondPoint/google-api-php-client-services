 ...
 *  </code>
 */
class Google_Service_Classroom_Resource_Invitations extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function accept($id, $optParams = array())
  {
    ...
    return $this->call('accept', array($params), "\GoogleApiServices\Google_Service_Classroom_ClassroomEmpty");
  }
  /**
  ...
  public function create(Google_Service_Classroom_Invitation $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "\GoogleApiServices\Google_Service_Classroom_Invitation");
  }
  /**
  ...
  public function get($id, $optParams = array())
  {
    $params = array('id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_Classroom_Invitation");
  }
  /**
  ...
  public function listInvitations($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Classroom_ListInvitationsResponse");
  }
}
