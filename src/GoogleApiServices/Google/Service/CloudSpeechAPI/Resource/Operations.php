 ...
 *  </code>
 */
class Google_Service_CloudSpeechAPI_Resource_Operations extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function cancel($name, Google_Service_CloudSpeechAPI_CancelOperationRequest $postBody, $optParams = array())
  {
    ...
    return $this->call('cancel', array($params), "\GoogleApiServices\Google_Service_CloudSpeechAPI_SpeechEmpty");
  }
  /**
  ...
  public function delete($name, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "\GoogleApiServices\Google_Service_CloudSpeechAPI_SpeechEmpty");
  }
  /**
  ...
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\GoogleApiServices\Google_Service_CloudSpeechAPI_Operation");
  }
  /**
  ...
  public function listOperations($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_CloudSpeechAPI_ListOperationsResponse");
  }
}
