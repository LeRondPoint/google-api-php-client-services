 ...
 *  </code>
 */
class Google_Service_QPXExpress_Resource_Trips extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function search(Google_Service_QPXExpress_TripsSearchRequest $postBody, $optParams = array())
  {
    ...
    return $this->call('search', array($params), "\GoogleApiServices\Google_Service_QPXExpress_TripsSearchResponse");
  }
}
