 ...
 *  </code>
 */
class Google_Service_Reports_Resource_Activities extends \GoogleApi\Google_Service_Resource
{
  /**
  ...
  public function listActivities($userKey, $applicationName, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "\GoogleApiServices\Google_Service_Reports_Activities");
  }
  /**
  ...
  public function watch($userKey, $applicationName, Google_Service_Reports_Channel $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('watch', array($params), "\GoogleApiServices\Google_Service_Reports_Channel");
  }
}
